...
interface CTASectionProps {
  title: string;
  body: string;
  primary: { label: string; href?: '/' | '/features' | '/pricing' | '/about' | '/blog' | '/contact'; external?: string };
  secondary?: { label: string; href?: '/' | '/features' | '/pricing' | '/about' | '/blog' | '/contact'; external?: string };
